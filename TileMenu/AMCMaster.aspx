...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="logine">
         ...
         <td>
         <table border="1">
                         <tr><td><label><b>Title/Description:</b><span class="required" style="color: red">*</span></label></td>
                         <td colspan="3"><asp:TextBox ID="txtdescription" runat="server" Enabled="True" Height="25px" Width="550px"></asp:TextBox></td>
                         </tr>
                         ...
                         <tr>
                         <td><label>PO Value:<span class="required" style="color: red">*</span></label></td>
                         <td><asp:TextBox ID="txtpovalue" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                         <td><label>Location.:</label></td>
                         <td><asp:TextBox ID="txtlocation" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                         </tr>
                 
                
                         <tr>
                         <td><label><span  style="color: green">@</span>Vendor/Supplier:<span class="required" style="color: red">*</span></label></td>
                         <td><asp:DropDownList ID="ddlvendor" runat="server" AutoPostBack="true" Height="25px" Width="150px" onselectedindexchanged="ddlvendor_SelectedIndexChanged"></asp:DropDownList></td>
                         <td><label>OEM:</label></td>
                         <td><asp:DropDownList ID="ddloem" runat="server" AutoPostBack="false" Height="25px" Width="150px"></asp:DropDownList></td>
                         </tr>

                         <tr>
                         <td><label>Sales Manager:</label></td>
                         <td><asp:DropDownList ID="ddlsales" runat="server" Height="25px" Width="150px" ></asp:DropDownList></td>
                         <td><label>Account Manager:</label></td>
                         <td><asp:DropDownList ID="ddlaccount" runat="server" Height="25px" Width="150px" ></asp:DropDownList></td>
                         </tr>
                 
                         <tr>
                         <td><label>Response Time(In Hrs):<span class="required" style="color: red">*</span></label></td>
                         <td><asp:TextBox ID="txtresponsetime" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                         <td><label>Resolution Time(In Hrs):<span class="required" style="color: red">*</span></label></td>
                         <td><asp:TextBox ID="txtresolutiontime" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                         </tr>

                          <tr>
                          <td><label>SLA:</label></td>
                          <td><asp:TextBox ID="txtSLA" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                          <td><label>Availability:</label></td>
                          <td><asp:TextBox ID="txtavailability" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                          </tr>

                         <tr id="tr1" runat="server" visible="false">
                         <td><label>Support Start Date:<span class="required" style="color: red">*</span></label></td>
                         <td><asp:TextBox ID="txtsupportstartdate" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox>mm/dd/yyyy</td>
                         <td><label>Support End Date:<span class="required" style="color: red">*</span></label></td>
                         <td><asp:TextBox ID="txtsupportenddate" runat="server" Enabled="True" Height="25px" Width="190px"></asp:TextBox>mm/dd/yyyy</td>
                         ...
                         <tr>
                         <td><label><span  style="color: green">@</span>Procurement Type:<span class="required" style="color: red">*</span></label></td>
                         <td>
                         ...
                         <td><label>License Key:</label></td>
                         <td><asp:TextBox ID="txtlicense" runat="server" Enabled="True" Height="25px" Width="200px"></asp:TextBox></td>
                         </tr>
                
                         <tr>
                         <td><label><span  style="color: green">@</span>Alert Required:<span class="required" style="color: red">*</span></label></td>
                         <td><asp:DropDownList ID="ddlalert" runat="server" AutoPostBack="true" Height="25px" Width="150px" onselectedindexchanged="ddlalert_SelectedIndexChanged">
                                      <asp:ListItem Text="--Select--" Value="-1"></asp:ListItem>
                                      <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                      <asp:ListItem Text="No" Value="No"></asp:ListItem>
                               </asp:DropDownList>
                         </td>
                         <td><label><span  style="color: green">@</span>Responsibility:<span class="required" style="color: red">*</span></label></td>
                         <td>
                    ...
                    <td><label>Status:</label></td>
                     ...
                     <td><asp:TextBox ID="txtattachment" runat="server" Enabled="false" Height="25px" Width="200px"></asp:TextBox></td>
                    </tr>
         ...
         <tr><td colspan="4" align="center"><asp:Button ID="btnsubmit" runat="server"  
