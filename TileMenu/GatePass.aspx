<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GatePass.aspx.cs" Inherits="TileMenu.GatePass" %>
        ...
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
               ...
               <asp:RadioButtonList ID="IssuedTo" runat="server" 
                          ...
                          <asp:ListItem Selected="True" Text="Employee/Site/Internal" Value="Employee" ></asp:ListItem>
                          <asp:ListItem  Text="Repair/Scrapped/Sold/Vendor" Value="Others"></asp:ListItem>
        ...
        <div class="col-12">
            <asp:GridView ID="gvSerial" runat="server" AutoGenerateColumns="False" CssClass="table" OnRowDataBound="gvSerial_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Asset Detail">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlsoutid" runat="server" CssClass="form-control" style="max-width: 600px;margin-left:150px"></asp:DropDownList>
