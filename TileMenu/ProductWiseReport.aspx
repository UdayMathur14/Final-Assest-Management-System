                 ...
                 ID="Button1" runat="server" Text="Search" onclick="Button1_Click" /> </td></tr>--%>
                        <tr>
                            <td colspan="3" style="font-weight: bold; font-size: large;">
                                <asp:Label ID="lblproductname" runat="server"></asp:Label><asp:Label ID="lbldistinctrecord" runat="server"></asp:Label>
                                <asp:ImageButton ID="btnclose" runat="server" ImageUrl="~/Close.png"
                                    OnClick="btnclose_Click" /></td>
                        </tr>
                        <tr runat="server" visible="false" id="trinheader">
                            <td colspan="3" style="font-weight: bold; color: #009933;">Item In Detail</td>
                        </tr>
                        <tr runat="server" visible="false" id="trindetail">
                            <td colspan="3">
                        ...
                        <tr runat="server" visible="false" id="troutdetail">
                            <td colspan="3">
                        ...
                        <tr runat="server" visible="false" id="travailable">
                            <td colspan="3">
